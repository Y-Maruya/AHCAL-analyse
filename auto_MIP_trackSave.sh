...
mkdir -p run${InputRunNumber}_calibed_chiunder2_tr${2}_tr${3}
cd run${InputRunNumber}_calibed_chiunder2_tr${2}_tr${3}
TriggerLayer1=$2
TriggerLayer2=$3
...
/afs/cern.ch/user/y/ymaruya/private/FASERlink/AHCAL-analyse/bin/ForMuon_eff_MIPcalibed_trackSave $filename /afs/cern.ch/user/y/ymaruya/private/FASERlink/AHCAL-analyse/calibration/pedestal.root /afs/cern.ch/user/y/ymaruya/private/FASERlink/AHCAL-analyse/calibration/dac.root /afs/cern.ch/user/y/ymaruya/private/FASERlink/AHCAL-analyse-EHN1/run32/MuonADC_offset.root_mip.root muon_full.root $2 $3 Save
